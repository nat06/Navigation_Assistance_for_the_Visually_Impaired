...
package com.example.rogergirgis.wsapplication.env;
...
public class ImageUtils {
   ...
   */
  public static void saveBitmap(final Bitmap bitmap, int image_number, String folderNumber) {
    saveBitmap(bitmap, "preview" + Integer.toString(image_number) + " .png", folderNumber);
  }
   ...
   */
  public static void saveBitmap(final Bitmap bitmap, final String filename, String folderNumber) {
    final String root =
        Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator +
                "WalkingStraight" + File.separator + "Orientation" +
